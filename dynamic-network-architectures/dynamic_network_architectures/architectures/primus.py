...
class PrimusV2S(PrimusV2X):
    def __init__(
        ...
        """Official PrimusV2-S Architecture with deeper patch embedding."""
        super().__init__(
            input_channels=input_channels,
            output_channels=output_channels,
            config_name="S",
...
class PrimusV2B(PrimusV2X):
    def __init__(
        ...
        """Official PrimusV2-B Architecture with deeper patch embedding."""
        super().__init__(
            input_channels=input_channels,
            output_channels=output_channels,
            config_name="B",
...
class PrimusV2M(PrimusV2X):
    def __init__(
        ...
        """Official PrimusV2-M Architecture with deeper patch embedding."""
        super().__init__(
            input_channels=input_channels,
            output_channels=output_channels,
            config_name="M",
...
class PrimusV2L(PrimusV2X):
    def __init__(
        ...
        """Official PrimusV2-L Architecture with deeper patch embedding."""
        super().__init__(
            input_channels=input_channels,
            output_channels=output_channels,
            config_name="L",
